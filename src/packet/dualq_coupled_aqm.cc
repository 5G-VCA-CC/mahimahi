...
void DualQCoupledAQM::set_queue_log_timer_16ms( void )
{
    const timespec interval { 0, 16 * NS_PER_MS }; // 16 ms
        ...
        Poller::Action(
            ...
            [&]() {
                ...
                std::cout
                    ...
                    << " drop_overflow=" << overflow_drop_pkts_
                    << " drop_overload=" << overload_drop_pkts_
                    << " drop_not_ect=" << not_ect_drop_pkts_
                    << '\n';
