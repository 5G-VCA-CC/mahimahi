...
def plot_byte_percentage_bar(file_path, interval=30):
    ...
    while i < len(lines):
        ...
        # Every interval, record percentages
        if t > 0 and t % interval == 0:
            ...
            # else: skip recording this interval entirely
    ...
    plt.title(f'L4S vs Classic Byte Share Every {interval} Decisions')
