...
run_test () {
  ...
  mm-delay $DELAY mm-link --meter-all \
    ...
    "$TRACE_UP" "$TRACE_DOWN" -- bash -c "
        echo '[+] Starting SCReAM senders with minrate 5000kbps...'
        $TX_BIN -minrate 10000 -ect 1 10.0.0.1 $PORT_L4S > scream_tx_l4s.log 2>&1 &
        $TX_BIN -minrate 10000 10.0.0.1 $PORT_CLASSIC > scream_tx_classic.log 2>&1 &
