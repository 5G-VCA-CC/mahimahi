...
def compute_percentages_random_intervals(l4s_data, classic_data, min_interval=5, max_interval=50):
    l4s_index = 0
    classic_index = 0
    time_points = []
    l4s_percentages = []
...
def plot_random_intervals(file_path):
    ...
    plt.ylabel('% of Bytes Sent')
    plt.title('Stacked Byte Share with Random Intervals (5-50 decisions)')
    plt.legend()
